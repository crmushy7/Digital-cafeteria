...
public class HistorySetGet {
    ...
    public HistorySetGet(final String food_name, final String food_price, final String coupon_reference_Number, final String coupon_date, final String coupon_status) {
